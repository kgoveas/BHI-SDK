...
FLASH_REM_SIZE    = TOTAL_FLASH_SIZE - FLASH_DESCR_SIZE - FLASH_FW_SIZE;
...
MEMORY {
    ...
    FLASH_PRIMARY_HDR: ORIGIN = 0x0020_1F84 LENGTH = 124
    FLASH_PRIMARY_FW:  ORIGIN = 0x0020_2000 LENGTH = MAX_FLASH_FW_SIZE
    FLASH:             ORIGIN = 0x0020_2000 + MAX_FLASH_FW_SIZE LENGTH = FLASH_REM_SIZE

    FLASH_SHADOW_NEW:  ORIGIN = 0x0000_0000 LENGTH = 0
    FLASH_SHADOW_HDR:  ORIGIN = 0x0000_0000 LENGTH = 0
    FLASH_SHADOW_FW:   ORIGIN = 0x0000_0000 LENGTH = 0
