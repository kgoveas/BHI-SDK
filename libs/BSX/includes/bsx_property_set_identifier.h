...
#define BSX_PROPERTY_SET_ID_HWDEPENDENT   (3)
...
#define BSX_PROPERTY_SET_ID_TIME_SCALING   (57)
#define BSX_PROPERTY_SET_ID_ACCELEROMETER_PREPROCESSOR_OFFLINE_CORRECTION   (21)
...
#define BSX_PROPERTY_SET_ID_MAGNETOMETER_CONDITIONING_FILTER   (39)
#define BSX_PROPERTY_SET_ID_ACCELEROMETER_CONDITIONING_FILTER   (40)
#define BSX_PROPERTY_SET_ID_GYROSCOPE_CONDITIONING_FILTER   (47)
...
#define BSX_PROPERTY_SET_ID_DIRECTIONTRACKER_EST_HEADING_ACCURACY_MAP   (46)
#define BSX_PROPERTY_SET_ID_DIRECTIONTRACKER_JUMP_CORRECTION   (48)
#define BSX_PROPERTY_SET_ID_DIRECTIONTRACKER_NDOF_VR   (49)
