...
//#define portSVC_RAISE_PRIVILEGE       0 - removed, was in di01
...
//#define portSVC_LOWER_PRIVILEGE       6 - removed, was in di01
//#define portSVC_IS_IN_ISR             7 - removed, was in di01
...
/* Lowest priority - global background region. Does not use an MPU region register pair. */
#define portDEFAULT_REGION_ATTRIBS          ( 0 ) // Default is no access;

#define portFLASH_REGION_ATTRIBS            ( portMPU_REGION_KERNEL_READ |     \
                                              portMPU_REGION_KERNEL_EXECUTE |  \
                                              portMPU_REGION_USER_EXECUTE)

#define portICCM_REGION_ATTRIBS             ( portMPU_REGION_KERNEL_READ |     \
                                              portMPU_REGION_KERNEL_WRITE |    \
                                              portMPU_REGION_KERNEL_EXECUTE |  \
                                              portMPU_REGION_USER_EXECUTE)

#define portDCCM_REGION_ATTRIBS             ( portMPU_REGION_KERNEL_READ |     \
                                              portMPU_REGION_KERNEL_WRITE |    \
                                              portMPU_REGION_USER_READ |       \
                                              portMPU_REGION_USER_WRITE)

#define portPERIPHERAL_ATTRIBS              ( portMPU_REGION_KERNEL_READ |     \
                                              portMPU_REGION_KERNEL_WRITE |    \
                                              portMPU_REGION_USER_READ |       \
                                              portMPU_REGION_USER_WRITE)

#define portKERNEL_PERIPHERAL_ATTRIBS       ( portMPU_REGION_KERNEL_READ |     \
                                              portMPU_REGION_KERNEL_WRITE)

#define portRO_PERIPHERAL_ATTRIBS           ( portMPU_REGION_KERNEL_READ |     \
                                              portMPU_REGION_KERNEL_WRITE |    \
                                              portMPU_REGION_USER_READ )


#define portUSER_PERIPHERALS_2_REGION       ( 0 ) /* PAD, UTMR */
#define portUSER_PERIPHERALS_1_REGION       ( 1 ) /* HIF */
#define portKERNEL_PERIPHERALS_REGION       ( 2 ) /* All Peripherals */
#define portDCCM_REGION                     ( 3 ) /* DCCM (User mode) */
#define portICCM_CONST_REGION               ( 4 ) /* ICCM Constatnts usable by user mode */
#define portKERNEL_DCCM_2_REGION            ( 5 ) /* Kernel DCCM */
#define portICCM_REGION                     ( 6 ) /* ICCM */
#define portFLASH_REGION                    ( 7 ) /* Covers Flash */
#define portNUM_REGIONS                     ( 8 )
...
extern mpu_region_t gDefaultMPUConfig[portNUM_REGIONS];
#endif
...
#define portTOTAL_NUM_REGIONS               ( 0 )
...
#if 0
// This doesn't actually works - ISRs are always above traps
...
extern void registerSyscallTable(void* table, UInt32 num_syscalls);

extern void registerKernelStackForUser(UInt32 base, UInt32 top);
/*-----------------------------------------------------------*/
