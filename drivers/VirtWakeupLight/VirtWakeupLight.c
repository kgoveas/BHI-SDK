...
/*!
 * @brief This function reports wakeup light data to host.
 *
 ...
 */
static SensorStatus virt_wakeup_light_handle_sensor_data(VirtualSensorDescriptor *self, void *data)
{
    PhysicalSensorDescriptor *phys_sensor_p = self->triggerSource.phys;
    uint16_t *wkup_light_phys_p = data; /* physical data */
 ...
 * @return Result of execution
 */
static SensorStatus virt_wakeup_light_get_last_sensor_data(VirtualSensorDescriptor *self)
{
    PhysicalSensorDescriptor *phys_sensor_p = self->triggerSource.phys;
    if (NULL == phys_sensor_p)
    {
 ...
 * @return None
 */
static void virt_wakeup_light_mode_changed(VirtualSensorDescriptor *self, SensorPowerMode mode)
{
    PhysicalSensorDescriptor *phys_sensor_p = self->triggerSource.phys;
...
VIRTUAL_SENSOR_DESCRIPTOR VirtualSensorDescriptor virt_wakeup_light_descriptor =
{
    .triggerSource = {
        .sensor = {
            .type = {
    ...
    .initialize = NULL,
    .handle_sensor_data = virt_wakeup_light_handle_sensor_data,
    .get_last_sensor_data = virt_wakeup_light_get_last_sensor_data,
    .mode_changed = virt_wakeup_light_mode_changed,
}; //lint !e785
