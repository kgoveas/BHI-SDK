 ...
 * @file         VirtPressure.c
 *
 * @brief        Virtual driver for the Pressure.
 *
 * @date        21/03/2016
 *
 */
/*!
 * @addtogroup VirtPressure
 * @brief
 * @{*/
 ...
 */
static SensorStatus virt_pressure_handle_sensor_data(VirtualSensorDescriptor* self, void *data)
{
    PhysicalSensorDescriptor *phy_bme = self->triggerSource.phys;
    uint32_t *pressure_phy = data;
    output_t output;
    uint32_t comp_p;
...
VIRTUAL_SENSOR_DESCRIPTOR VirtualSensorDescriptor virt_pressure_descriptor =
{
    .triggerSource =
    {
        .sensor =
    ...
    .initialize = NULL,
    .handle_sensor_data = virt_pressure_handle_sensor_data,
}; //lint !e785
