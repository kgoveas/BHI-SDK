 ...
 *
 * @file         VirtWakeupGas.c
 *
 * @brief        Virtual driver for the wakeup gas sensor
 *
 * @date        21/03/2016
 *
 */
/*!
 * @addtogroup VirtWakeupGas
 * @brief
 * @{*/
 ...
 */
static SensorStatus virt_wakeup_gas_handle_sensor_data(VirtualSensorDescriptor *self, void *data)
{
    PhysicalSensorDescriptor* phy_bme = self->triggerSource.phys;
    output_t output;
    int32_t *wkup_gas_phy = data;
...
VIRTUAL_SENSOR_DESCRIPTOR VirtualSensorDescriptor virt_wakeup_gas_descriptor =
{
    .triggerSource =
    {
        .sensor =
    ...
    .initialize = NULL,
    .handle_sensor_data = virt_wakeup_gas_handle_sensor_data,
};//lint !e785
